package com.example.mobile_client_app.features.auth.registering.presentaion.ui
            ...
            viewModelScope.launch {
                createUserUseCase.invoke(
                    ...
                    .onError { error ->
                        ...
                        isLoading = false
                        _events.value = RegisteringEvent.ShowSnackbar(message = error.displayMessage)
                    }
            }
        }
    }
